fireworksColor = ["#c7fbff", "#fedaff", "#daffe2", "#f5ffda"]; //烟火颜色
fireworksCircleColor = "#f5ffda"; //彩环颜色
! function () {
	...
	if (("false" !== n.getAttribute("mobile") || !/Android|webOS|iPhone|iPod|iPad|BlackBerry/i.test(navigator.userAgent)) && n) {
			...
			n = this, e = function() {
						...
						return function(t, r, a, u) {
							...
							function l(r) {
								...
								return d >= .001 ? function(n, e, t, r) {
									...
									for (var o, u, c = 0;
										(o = i(u = e + (t - e) / 2, r, a) - n) > 0 ? t = u : e = u, Math.abs(o) > 1e-7 && ++c < 10;);
									return u
								}(r, u, u + e, t, a)
							}
						}
				...
				function j(n) {
					...
					switch (n.tagName.toLowerCase()) {
						...
						case "polygon":
							return t = (e = n)
								.points, W(e) + L(t.getItem(t.numberOfItems - 1), t.getItem(0))
					}
					var e, t, r, a, i
				}
				...
				function en(t) {
					...
					var f, d, p, h, g, m, y, b, w = (d = M(n, f = t), h = G(p = M(e, f), f), y = _(m = Q(g = X(f.targets), h), p), b = J, J++, P(d, {
						id: b,
						children: [],
						animatables: g,
						animations: m,
					...
					function F(n) {
						...
						w.progress = a(d / e * 100, 0, 100), w.reversePlayback = d < w.currentTime, r && function(n) {
							if (w.reversePlayback)
								for (var e = c; e--;) O(n, r[e]);
							else
								for (var t = 0; t < c; t++) O(n, r[t])
		...
		var e = n.getContext("2d"),
			...
			r = 0,
			a = 0,
			i = fireworksColor,//控制彩球颜色
			o = function(n, e, t) {
				let r;
				return function() {
					const a = this,
					fireworksColor = arguments,
						o = function() {
							r = null, t || n.apply(a, fireworksColor)
						},
						u = t && !r;
					clearTimeout(r), r = setTimeout(o, e), u && n.apply(a, fireworksColor)
				}
			}((function() {
				n.width = window.innerWidth, n.height = window.innerHeight, n.style.width = window.innerWidth + "px", n.style.height = window.innerHeight + "px", n.getContext("2d")
					.scale(1, 1)
			}), 500),
			u = anime({
				duration: 1 / 0,
		...
		document.addEventListener("mousedown", (function(i) {
			"sidebar" !== i.target.id && "toggle-sidebar" !== i.target.id && "A" !== i.target.nodeName && "IMG" !== i.target.nodeName && (u.play(), function(e) {
				r = (e.clientX || e.touches[0].clientX) - n.getBoundingClientRect()
					.left, a = e.clientY || e.touches[0].clientY - n.getBoundingClientRect()
					.top
			}(i), function(n, r) {
				for (var a = function(n, t) {
					var r = {};
					return r.x = n, r.y = t, r.color = fireworksCircleColor, r.radius = .1, r.alpha = .5, r.lineWidth = 6, r.draw = function() { //圆环颜色
	...
	function c(n, t) {
		var r = {};
		return r.x = n, r.y = t, r.color = fireworksColor[anime.random(0, fireworksColor.length - 1)], r.radius = anime.random(16, 32), r.endPos = function(n) {
